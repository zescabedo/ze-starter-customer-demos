    ...
    <div className="px-4">
      {testimonialAttribution?.jsonValue && (
        <div className="flex flex-col gap-4">
          <div className="flex flex-row gap-[24px]">
            ...
            <Text
              tag="p"
              className="text-accent text-sm font-semibold uppercase tracking-wide"
      ...
      <div className="space-y-4">
        {testimonialQuote?.jsonValue && (
          <Text
            tag="p"
            className="text-accent @md:text-4xl  @lg:text-5xl font-heading text-3xl font-normal tracking-tight"
