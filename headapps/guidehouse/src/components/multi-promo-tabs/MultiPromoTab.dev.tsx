      ...
      <div className="multi-promo-tab @md:grid-cols-2 @md:my-16 my-8 grid grid-cols-1 gap-6">
        <div className="flex flex-col gap-4">
          ...
          <Button
            ...
            className="bg-popover hover:bg-popover hover:text-popover-foreground text-popover-foreground font-body letter-spacing-[-0.8] flex w-fit items-center gap-2 px-4 py-2"
  ...
  return (
    <div className="multi-promo-tab @md:grid-cols-2 @md:my-16 my-8 grid grid-cols-1 gap-6">
      <motion.div
        ...
        exit={{ opacity: 0, y: -20 }}
        className="group/card1 relative block overflow-hidden"
        onClick={(e) =>
          handleClick(
            e,
      ...
      >
        ...
        {link1?.jsonValue?.value?.href && (
          <Button
            icon={{ value: 'arrow-up-right' }}
            iconClassName="h-4 w-4"
            className="bg-popover hover:bg-popover hover:text-popover-foreground text-popover-foreground font-body letter-spacing-[-0.8] absolute bottom-4 left-4 flex items-center gap-2 px-4 py-2 backdrop-blur-sm transition-all duration-500 group-hover/card1:translate-x-2"
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        exit={{ opacity: 0, y: -20 }}
        className="group/card2 relative block overflow-hidden"
        onClick={(e) =>
          handleClick(
            e,
      ...
      >
        ...
        {link2?.jsonValue?.value?.href && (
          <Button
            icon={{ value: 'arrow-up-right' }}
            iconClassName="h-4 w-4"
            className="bg-popover hover:bg-popover hover:text-popover-foreground text-popover-foreground font-body letter-spacing-[-0.8] absolute bottom-4 left-4 flex items-center gap-2 px-4 py-2 backdrop-blur-sm transition-all duration-500 group-hover/card2:translate-x-2"
