        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="@md:grid-cols-2 mb-[28px] grid gap-8">
            {featuredArticles.map((article, index) => (
              <div key={index} className="@md:mb-0 group/article mb-6">
                {isPageEditing ? (
                  <div className="@md:mb-0 mb-4 aspect-[3/2] w-full overflow-hidden">
                    <img
                      src={article.image}
                      alt={article.title}
          ...
          <div className="@sm:grid-cols-2 @lg:grid-cols-3 grid gap-8">
            {regularArticles.map((article, index) => (
              <div
                key={index}
                className="@md:p-8 hover:bg-tertiary-hover focus:ring-accent group/article flex h-full flex-col p-4 transition-colors focus:outline-none focus:ring-2"
              >
                <div>
                  {isPageEditing ? (
